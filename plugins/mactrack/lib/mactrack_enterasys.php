...
function get_enterasys_switch_ports($site, &$device, $lowPort = 0, $highPort = 0) {
	...
	$vlan_ids = xform_standard_indexed_data(".1.3.6.1.4.1.52.4.1.2.16.3.1.1.5.4", $device); //.1.3.6.1.4.1.52.4.1.2.16.4.4.1.2

	/* get VLAN Trunk status */
	//$vlan_trunkstatus = xform_standard_indexed_data(".1.3.6.1.2.1.17.7.1.4.3.1.1", $device); //.1.3.6.1.4.1.52.4.1.2.16.3.1.1.5.4
	$device["vlans_total"] = sizeof($vlan_ids); //sizeof($vlan_trunkstatus);
